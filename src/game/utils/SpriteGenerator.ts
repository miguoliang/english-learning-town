/**
 * Utility class for generating simple character sprites programmatically
 * This creates basic but recognizable character sprites as an alternative to emojis
 */
export class SpriteGenerator {
   ...
   */
  static initializeAllSprites(scene: Phaser.Scene): void {
    const spriteSize = 64;

    // Create character sprites
    this.createCharacterSprite(scene, spriteSize, spriteSize, {
      name: 'player',
      skinColor: 0xfdbcb4,
      hairColor: 0x8b4513,
      shirtColor: 0x4169e1,
    ...
    this.createItemSprite(scene, itemSize, itemSize, {
      name: 'book',
