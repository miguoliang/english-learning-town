...
class GraphemerHelper {
  ...
  static shouldBreak(start, mid, end, startEmoji, midEmoji, endEmoji) {
    ...
    if (
      ...
      [boundaries_1.CLUSTER_BREAK.PREPEND, boundaries_1.CLUSTER_BREAK.REGIONAL_INDICATOR].indexOf(
        previous
      ) === -1
    ) {
      if (
    ...
    // GB7. (LV|V) × (V|T)
      ...
      (previous === boundaries_1.CLUSTER_BREAK.LV || previous === boundaries_1.CLUSTER_BREAK.V) &&
    ...
    // GB8. (LVT|T) × (T)
      ...
      (previous === boundaries_1.CLUSTER_BREAK.LVT || previous === boundaries_1.CLUSTER_BREAK.T) &&
