...
export const LearningStage = {
  NEW: 'NEW',           // Just learned, needs frequent review
  LEARNING: 'LEARNING', // In active learning phase
  REVIEW: 'REVIEW',     // Ready for spaced review
  MASTERED: 'MASTERED', // Well known, infrequent review
  RELEARNING: 'RELEARNING' // Forgotten, needs relearning
} as const;

export type LearningStage = typeof LearningStage[keyof typeof LearningStage];

export const ReviewResult = {
  FORGOT: 'FORGOT',     // 0 - Complete failure
  HARD: 'HARD',         // 1 - Difficult recall
  GOOD: 'GOOD',         // 2 - Normal recall
  EASY: 'EASY'          // 3 - Easy recall
} as const;
