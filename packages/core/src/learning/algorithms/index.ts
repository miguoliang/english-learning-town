 ...
 * Core learning algorithms for vocabulary acquisition and difficulty adaptation
 */

// Spaced Repetition Algorithm
export { SpacedRepetitionEngine } from './spacedRepetition';
export type { VocabularyCard } from './spacedRepetition';

// Adaptive Difficulty Calibration  
export * from './difficultyCalibration';

// Review Session Management  
export { ReviewSessionManager } from './reviewSession';
export type { ReviewSessionConfig } from './reviewSession';
export type { ReviewSession } from './reviewSession';
