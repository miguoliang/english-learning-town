...
describe("AI System", () => {
  ...
  describe("System Setup", () => {
    it("should have correct name and required components", () => {
      ...
      expect(aiSystem.requiredComponents).toEqual([
        "position",
        "ai",
        "velocity",
      ]);
...
describe("Health System", () => {
  ...
  describe("Health Regeneration", () => {
    it("should regenerate health over time", () => {
      ...
      const healthSystem = world
        .getSystems()
        .find((s) => s.name === "HealthSystem") as HealthSystem;
  ...
  describe("Damage and Healing", () => {
    it("should apply damage correctly", () => {
      ...
      const success = healthSystem.damage(
        entity.id,
        30,
        world.getComponentManager(),
        events,
    ...
    it("should heal entities correctly", () => {
      ...
      const success = healthSystem.heal(
        entity.id,
        40,
        world.getComponentManager(),
        events,
...
describe("Timer System", () => {
  ...
  describe("Timer Operations", () => {
    ...
    it("should emit completion event", () => {
      ...
      world.addComponent(
        entity.id,
        createTimerComponent(100, false, "timer:completed"),
      );
...
describe("State Machine System", () => {
  ...
  describe("State Transitions", () => {
    it("should change state successfully", () => {
      ...
      world.addComponent(
        entity.id,
        createStateComponent("idle", {}, transitions),
      );

      const eventSpy = vi.fn();
      events.on("state:changed" as keyof ECSEvents, eventSpy);

      const success = stateSystem.changeState(
        entity.id,
        "walking",
        world.getComponentManager(),
        events,
    ...
    it("should reject invalid transitions", () => {
      ...
      world.addComponent(
        entity.id,
        createStateComponent("locked", {}, transitions),
      );
