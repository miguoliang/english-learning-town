...
describe("XPProgressBar Component", () => {
  it("renders with basic props", () => {
    renderWithTheme(
      <XPProgressBar currentLevel={5} totalXP={450} xpToNextLevel={50} />,
    );
  ...
  it("handles max level state", () => {
    renderWithTheme(
      <XPProgressBar currentLevel={50} totalXP={5000} xpToNextLevel={0} />,
    );
  ...
  it("handles zero XP to next level", () => {
    renderWithTheme(
      <XPProgressBar currentLevel={20} totalXP={2000} xpToNextLevel={0} />,
    );
  ...
  it("renders level badge with correct styling", () => {
    renderWithTheme(
      <XPProgressBar currentLevel={15} totalXP={1450} xpToNextLevel={50} />,
    );
  ...
  it("shows appropriate XP remaining text", () => {
    renderWithTheme(
      <XPProgressBar currentLevel={8} totalXP={750} xpToNextLevel={250} />,
    );
