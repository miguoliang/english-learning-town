...
describe("LoadingScreen Component", () => {
  it("renders loading screen with default message", () => {
    ...
    expect(
      screen.getByText("Please wait while we prepare your learning adventure!"),
    ).toBeInTheDocument();
  ...
  it("renders subtitle when provided", () => {
    ...
    expect(
      screen.getByText("Please wait while we prepare your adventure"),
    ).toBeInTheDocument();
  });
  ...
  it("displays hints when provided", () => {
    ...
    expect(
      screen.getByText("💡 Tip: Practice speaking every day!"),
    ).toBeInTheDocument();
    expect(
      screen.getByText("💡 Tip: Try talking to NPCs for vocabulary practice"),
    ).toBeInTheDocument();
  });
