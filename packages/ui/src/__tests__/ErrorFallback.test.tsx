...
describe("ErrorFallback Component", () => {
  ...
  it("renders with default props", () => {
    renderWithTheme(<ErrorFallback error={mockError} retry={mockRetry} />);
  ...
  it("renders minimal variant correctly", () => {
    renderWithTheme(
      <ErrorFallback error={mockError} retry={mockRetry} variant="minimal" />,
    );
  ...
  it("hides retry button when showRetry is false", () => {
    renderWithTheme(
      <ErrorFallback error={mockError} retry={mockRetry} showRetry={false} />,
    );
  ...
  it("hides refresh button when showRefresh is false", () => {
    renderWithTheme(
      <ErrorFallback error={mockError} retry={mockRetry} showRefresh={false} />,
    );
  ...
  it("displays custom emoji", () => {
    renderWithTheme(
      <ErrorFallback error={mockError} retry={mockRetry} emoji="🚫" />,
    );
  ...
  it("handles different error types", () => {
    ...
    renderWithTheme(<ErrorFallback error={customError} retry={mockRetry} />);

    expect(
      screen.getByText(/Error: TypeError - Type error occurred/),
    ).toBeInTheDocument();
  });
