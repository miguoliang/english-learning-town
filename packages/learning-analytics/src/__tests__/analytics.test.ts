...
describe("LearningAnalyticsEngine", () => {
  ...
  describe("Analytics Generation", () => {
    ...
    beforeEach(() => {
      analytics = LearningAnalyticsEngine.generateAnalytics(
        sampleCards,
        sampleSessions,
      );
    });
  ...
  describe("Insights Generation", () => {
    ...
    it("should create insights with correct structure", () => {
      insights.forEach((insight) => {
        ...
        expect(["CELEBRATION", "RECOMMENDATION", "TIP", "WARNING"]).toContain(
          insight.type,
        );
      });
    });
    ...
    it("should generate celebration insights for high performance", () => {
      ...
      const celebrationInsights = LearningAnalyticsEngine.generateInsights(
        highPerformanceAnalytics,
      );
      const celebrations = celebrationInsights.filter(
        (i) => i.type === "CELEBRATION",
      );
    ...
    it("should generate recommendation insights for improvement areas", () => {
      ...
      const improvementInsights = LearningAnalyticsEngine.generateInsights(
        lowPerformanceAnalytics,
      );
      const recommendations = improvementInsights.filter(
    ...
    it("should generate tip insights for learning optimization", () => {
      ...
      const tipInsights =
        LearningAnalyticsEngine.generateInsights(analyticsWithAreas);
  ...
  describe("Edge Cases and Error Handling", () => {
    ...
    it("should handle sessions with zero duration", () => {
      const zeroDurationSessions = [{ ...sampleSessions[0], totalTime: 0 }];

      const analytics = LearningAnalyticsEngine.generateAnalytics(
        sampleCards,
        zeroDurationSessions,
      );
    ...
    it("should handle cards with invalid tags", () => {
      ...
      expect(() => {
        LearningAnalyticsEngine.generateAnalytics(
          invalidTagCards,
          sampleSessions,
        );
      }).not.toThrow();
  ...
  describe("Performance and Consistency", () => {
    it("should generate consistent results for same input", () => {
      const analytics1 = LearningAnalyticsEngine.generateAnalytics(
        sampleCards,
        sampleSessions,
      );
      const analytics2 = LearningAnalyticsEngine.generateAnalytics(
        sampleCards,
        sampleSessions,
      );
    ...
    it("should maintain data integrity", () => {
      ...
      expect(
        analytics.activeCards + analytics.masteredCards,
      ).toBeLessThanOrEqual(analytics.totalWordsLearned + 1);
