...
const GridContainer = styled.div.withConfig({
  shouldForwardProp: (prop) =>
    !["cellSize", "gridWidth", "gridHeight"].includes(prop),
  ...
  &::before {
    ...
    background-size: ${(props) => props.cellSize}px
...
const GridCellHighlight = styled.div.withConfig({
  shouldForwardProp: (prop) =>
    !["x", "y", "cellSize", "width", "height", "color"].includes(prop),
})<{
  x: number;
  y: number;
  cellSize: number;
