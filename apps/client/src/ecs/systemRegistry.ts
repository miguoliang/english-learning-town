...
export const EVENT_DRIVEN_SYSTEMS = [SYSTEM_NAMES.RENDER] as const;
...
export class SystemFactory {
  static createSystems() {
    ...
    return {
      ...
      playerInteraction: new PlayerInteractionSystem(
        inputStateSystem,
        interactionZoneSystem,
      ), // Inject input and zone dependencies
  ...
  static isEventDrivenSystem(systemName: string): boolean {
    return EVENT_DRIVEN_SYSTEMS.includes(
      systemName as (typeof EVENT_DRIVEN_SYSTEMS)[number],
    );
  }
}
